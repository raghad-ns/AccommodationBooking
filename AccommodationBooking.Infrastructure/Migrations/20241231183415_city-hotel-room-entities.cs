...
{
    /// <inheritdoc />
    public partial class cityhotelroomentities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "22cdafe8-4a68-4109-8caf-a5e59d60daec");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "ccbadf47-7cce-41cd-ba5e-6e8336101937");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostOfficeCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "22cdafe8-4a68-4109-8caf-a5e59d60daec", null, "Admin", "ADMIN" },
                    { "ccbadf47-7cce-41cd-ba5e-6e8336101937", null, "User", "USER" }
                });
        }
    }
}
